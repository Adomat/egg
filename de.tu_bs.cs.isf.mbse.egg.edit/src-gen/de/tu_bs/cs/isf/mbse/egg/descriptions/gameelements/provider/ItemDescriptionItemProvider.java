...
/**
 * This is the item provider adapter for a {@link de.tu_bs.cs.isf.mbse.egg.descriptions.gameelements.ItemDescription} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addAnimationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ItemDescription_animation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ItemDescription_animation_feature", "_UI_ItemDescription_type"),
				 GameelementsPackage.Literals.ITEM_DESCRIPTION__ANIMATION,
				 true,
				 false,
				 true,
				 null,

...
/**
 * This is the item provider adapter for a {@link de.tu_bs.isf.cs.mbse.egg.level.Level} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LevelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Level_gravity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Level_gravity_feature", "_UI_Level_type"),
				 LevelPackage.Literals.LEVEL__GRAVITY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Level_type") + " " + level.getGravity();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Level.class)) {
			case LevelPackage.LEVEL__GRAVITY:
